...
// TODO DOM
    var t = `
        ...
        <br>
            ...
            <span class="todo-create-time">创建时间：${todo.created_time}</span>
            <span class="todo-update-time">更新时间：${todo.updated_time}</span>
    ...
    todoList.addEventListener('click', function(event) {
        ...
        if (self.classList.contains('todo-update')) {
            ...
            apiTodoUpdate(form, function(todo) {
                ...
                var todoCT = e('.todo-create-time', todoCell)
                todoCT.innerText = "创建时间：" + todo.created_time
                var todoUT = e('.todo-update-time', todoCell)
                todoUT.innerText = "更新时间：" + todo.updated_time
